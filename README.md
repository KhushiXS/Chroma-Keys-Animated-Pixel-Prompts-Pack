...
- Includes 5 distinct color themes:
  ...
  03. Danger Red (Action/Alerts)
  04. Dark Terminal (Cyberpunk/Hacking)
...
- All Original .aseprite Source Files: The editable Aseprite files for all 5 color themes. Perfect for adjusting colors, tweaking layers, or exporting custom sprite sheets.
...
2. Freedom to Modify: You may freely modify, crop, or recolor these assets to fit your project's needs.
3. No Redistribution or Reselling: You may NOT redistribute, share, or resell the raw asset files (including PNGs, Aseprite source files, and GIFs). If someone else needs them, please direct them to this Itch.io page to download or purchase.
4. Attribution: Credit is not strictly required, but a mention in your game's credits (Chroma Keys Pack) would be highly appreciated!
